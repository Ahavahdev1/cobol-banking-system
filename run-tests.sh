...
compile_and_run "TEST-ACHRECV" "ACHRECV0" "AUDTLOG0" "REGDCHK0" "OFACCHK0"
...
compile_and_run "TEST-INTEG-FULL" "TXNPOST0" "INTCALC0" "FEECALC0" "ACHRECV0" \
    ...
    "AUDTLOG0" "REGDCHK0" "LOANPMT0" "DISPMGT0" "ODMGMT0"
...
compile_and_run "TEST-INTEG-EOM" "EOMPROC0" "TXNPOST0" "FEECALC0" "AUDTLOG0"
