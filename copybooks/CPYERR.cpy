...
01  ERROR-CODES.
    ...
    *> Account errors
    ...
    05  ERR-ACCT-ESCHEATED        PIC X(5) VALUE "E0044".
    05  ERR-ACCT-GARNISHMENT      PIC X(5) VALUE "E0045".
    05  ERR-CIF-MISSING-DOB       PIC X(5) VALUE "E0046".
    05  ERR-ACCT-HAS-ACCRUED-INT PIC X(5) VALUE "E0047".
    05  ERR-ACCT-PAST-DUE        PIC X(5) VALUE "E0048".
    05  ERR-ACCT-HAS-ESCROW      PIC X(5) VALUE "E0049".
    05  ERR-ACCT-RESTRICTED      PIC X(5) VALUE "E0043".
    *> CIF errors
    ...
    05  ERR-CIF-UNDERAGE          PIC X(5) VALUE "E0029".
    *> Transaction errors
    ...
    05  ERR-CD-EARLY-WD-NOACK    PIC X(5) VALUE "E0039".
    ...
    *> Compliance errors
    ...
    05  ERR-CIP-DOC-EXPIRED      PIC X(5) VALUE "E0084".
    *> Dispute errors (Regulation E)
    05  ERR-DSP-INVALID-TYPE     PIC X(5) VALUE "E0085".
    05  ERR-DSP-INVALID-STATUS   PIC X(5) VALUE "E0086".
    05  ERR-DSP-NOT-FOUND        PIC X(5) VALUE "E0087".
    05  ERR-APY-INVALID-FREQ     PIC X(5) VALUE "E0088".
    05  ERR-BSA-INVALID-DIR      PIC X(5) VALUE "E0089".
    *> ACH errors
